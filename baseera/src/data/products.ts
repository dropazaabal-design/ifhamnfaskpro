 ...
 *
 * 1 — الإفصاح: كل توصية مكتوب بجوارها أنها من الجهة التي تموّل المنصّة.
 * 2 — الصلة: التوصية مرتبطة بموضوع الاختبار، لا بنتيجتك «السيّئة». لا
 *     نقول لأحد «نتيجتك منخفضة، اشترِ هذا» — هذا استغلال للقلق.
 * 3 — القياس: كل رابط يحمل UTM، فيعرف المتجر ما جاء من بصيرة وما حوّله.
 */
