...
?>
<table class="shop_table woocommerce-checkout-review-order-table mp-review">
	<tbody>
		<?php
		...
		foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
			...
			<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
				<th class="product-name" scope="row">
					<?php echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', $_product->get_name(), $cart_item, $cart_item_key ) ); ?>
					<span class="mp-review__qty mp-num">×&nbsp;<?php echo esc_html( $cart_item['quantity'] ); ?></span>
	...
	<tfoot>
		<tr class="cart-subtotal">
			<th scope="row"><?php esc_html_e( 'المجموع الفرعي', 'matjar-pro' ); ?></th>
		...
		<tr class="order-total">
			<th scope="row"><?php esc_html_e( 'الإجمالي', 'matjar-pro' ); ?></th>
